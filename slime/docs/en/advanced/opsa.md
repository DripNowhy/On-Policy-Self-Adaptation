...
OPSA (On-Policy Self-Adaptation) applies policy loss only to the current actor's
...
Run the commands below from the modified Slime project directory
(`On-Policy-Self-Adaptation/slime`):
